...
namespace ElecShop.Services
{
    ...
    {
        public static void SendEmail(string senderName, string senderEmail, string receiverName, string receiverEmail, string textContent, string subject)
        {
            ...
            { 
                Console.WriteLine("Email Sender Failure: "+ e.Message);  
            }
        }
    }
}
